...
from ruintona.my_experiments.audio_models.CNN.CNN_BiLSTM import EmotionCNNBiLSTM  # noqa: E402
from ruintona.my_experiments.text_models.transformers.RuBERT import EmotionClassifier  # noqa: E402

PROJECT_ROOT = Path(__file__).resolve().parents[3]
MULTIMODAL_CHK = PROJECT_ROOT / "ruintona" / "my_experiments" / "checkpoints" / "multimodal"
