...
> Мотивация исследования, постановка проблемы, выбор данных, проверка готовых решений и гипотеза, а также результаты и их статистическая значимость — в [`RESEARCH.md`](./RESEARCH.md). Это основной научный документ, описывающий цель этого раздела.
...
| Раздел | README |
|---|---|
| **Мотивация, гипотеза и результаты исследования** | [`RESEARCH.md`](./RESEARCH.md) |
