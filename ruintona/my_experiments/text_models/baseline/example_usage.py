...
try:
    ...
    from ruintona.my_experiments.text_models.baseline.Embeddings_LogReg import (
        text_to_vector,
        DEFAULT_EMBEDDINGS_PATH,
        MODELS_DIR,
        MODEL_NAME,
    )
    from ruintona.my_experiments.utils.config_utils import get_dataset_path, get_dataset_name
