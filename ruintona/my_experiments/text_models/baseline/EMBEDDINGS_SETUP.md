...
poetry run python ruintona/my_experiments/text_models/baseline/Embeddings_LogReg.py \
    --mode train \
...
2. Читает тексты из LMDB (текстовые ключи: `text` / `speaker_text` / `transcript` / `utterance`)
