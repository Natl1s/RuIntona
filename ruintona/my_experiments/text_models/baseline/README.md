...
poetry run python ruintona/my_experiments/text_models/baseline/TF-IDF_LogReg.py --mode load

# Автоматический режим (загрузить если есть, иначе обучить)
poetry run python ruintona/my_experiments/text_models/baseline/TF-IDF_LogReg.py --mode auto

# Обучить без сохранения
poetry run python ruintona/my_experiments/text_models/baseline/TF-IDF_LogReg.py --mode train --no-save
```
...
poetry run python ruintona/my_experiments/text_models/baseline/Embeddings_LogReg.py --mode train

# Указать путь к embeddings
poetry run python ruintona/my_experiments/text_models/baseline/Embeddings_LogReg.py --mode train --embeddings-path /path/to/cc.ru.300.bin

# Загрузить существующую модель и оценить
poetry run python ruintona/my_experiments/text_models/baseline/Embeddings_LogReg.py --mode load

# Автоматический режим (загрузить если есть, иначе обучить)
poetry run python ruintona/my_experiments/text_models/baseline/Embeddings_LogReg.py --mode auto

# Обучить без сохранения
poetry run python ruintona/my_experiments/text_models/baseline/Embeddings_LogReg.py --mode train --no-save
```
