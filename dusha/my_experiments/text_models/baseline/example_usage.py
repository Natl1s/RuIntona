...
try:
    from dusha.my_experiments.utils.text_utils import preprocess_text, load_fasttext_model
    from dusha.my_experiments.text_models.baseline.Embeddings_LogReg import (
        text_to_vector,
        DEFAULT_EMBEDDINGS_PATH,
        MODELS_DIR,
        MODEL_NAME,
    )
    from dusha.my_experiments.utils.config_utils import get_dataset_path, get_dataset_name
    from dusha.my_experiments.utils.model_io import load_sklearn_model
    IMPORTS_OK = True
...
def main():
    ...
    train_manifest = get_dataset_path() / 'processed_dataset_090' / 'aggregated_dataset' / 'combine_balanced_train.lmdb'
