...
from dusha.my_experiments.utils.config_utils import TARGET_NAMES, get_dataset_name, models_dir_for, load_experiment_config, apply_config_to_args, add_config_arg, add_data_path_args, resolve_data_paths, CONFIGS_DIR
...
def _write_tuned_config(
    ...
    *,
    ...
    updated = {
        ...
        "_script": "dusha/my_experiments/audio_models/CNN/CNN_BiLSTM.py",
        "conv_channels": list(conv_channels),
