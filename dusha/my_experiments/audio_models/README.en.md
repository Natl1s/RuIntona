...
poetry run python dusha/my_experiments/audio_models/baseline/svm.py --mode train
poetry run python dusha/my_experiments/audio_models/baseline/random_forest.py --mode train

# OpenSMILE + XGBoost (needs opensmile, xgboost: poetry install --with audio-extra)
poetry run python dusha/my_experiments/audio_models/baseline/openSmile_XGBoost.py --mode train

# CNN / CNN-BiLSTM
poetry run python dusha/my_experiments/audio_models/CNN/CNN.py --mode train --config audio/cnn.json
poetry run python dusha/my_experiments/audio_models/CNN/CNN_BiLSTM.py --mode train --config audio/cnn_bilstm.json

# Wav2Vec2 XLS-R 300M + Self-Attention
poetry run python dusha/my_experiments/audio_models/transformers/wav2vec_self_attention.py \
...
poetry run python dusha/my_experiments/audio_models/baseline/random_forest.py \
