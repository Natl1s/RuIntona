...
from dusha.my_experiments.utils.model_io import load_pytorch_model, load_sklearn_model, load_torch_with_weights
        ...
        with self.env.begin() as txn:
            for idx in tqdm(
                ...
                if not isinstance(payload, dict):
                    continue
                text = extract_text(payload, lowercase=False)
                if not text:
                    continue
                try:
