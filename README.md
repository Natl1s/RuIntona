...
> Мотивация исследования, постановка проблемы, выбор данных, проверка готовых решений и гипотеза, а также эксперименты, их результаты и статистическая значимость — в [`RESEARCH.md`](./ruintona/my_experiments/RESEARCH.md). Это ключевой документ о том, почему ведётся это исследование.
...
| Мотивация, гипотеза и результаты исследования | [`RESEARCH.md`](./ruintona/my_experiments/RESEARCH.md) |
